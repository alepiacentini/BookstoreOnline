  ...
  async function handleAdminLogin() {
    ...
    try {
      ...
      if (!data.user.isAdmin) {
        errore = 'Accesso negato: non sei un amministratore';
        return;
      }
...
<div class="container">
  <div class="content">
    <h2 class="monsieur-la-doulaise-regular">Login Amministratore</h2>

    <form class="form" on:submit|preventDefault={handleAdminLogin}>
  <div class="title">
  <div class="main-title">Benvenuto</div>
  <div class="subtitle">effettua il login come amministratore</div>
</div>
